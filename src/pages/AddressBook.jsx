            ...
            <aside className="w-full lg:w-1/4 shrink-0">
              <div className="bg-white dark:bg-[#1e2227] rounded-xl border border-slate-200 dark:border-[#2d343b] p-6">
                ...
                <nav className="flex flex-col gap-1">
                  ...
                  <Link to="/addresses" className="flex items-center gap-3 px-4 py-3 text-sm rounded-lg bg-[#135bec]/10 text-[#135bec] font-semibold">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                {addresses.map((address) => (
                  <div
                    key={address.id}
                    className={`group relative bg-white dark:bg-[#1e2227] rounded-xl p-6 transition-all flex flex-col justify-between overflow-hidden ${address.isDefault
