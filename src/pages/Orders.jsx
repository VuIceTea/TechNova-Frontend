            ...
            <div className="bg-white dark:bg-[#2E3236] rounded-xl border border-slate-200 dark:border-slate-800 p-4 sticky top-24">
              <div className="flex items-center gap-4 mb-8 p-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Thành viên Bạc</p>
                </div>
              </div>

              <ul className="space-y-1">
                <li>
                  <Link to="/profile" className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                    <span className="material-symbols-outlined text-xl">person</span> Thông tin cá nhân
                  </Link>
                </li>
                <li>
                  <Link to="/orders" className="flex items-center gap-3 px-3 py-2.5 text-sm font-bold rounded-lg bg-[#135bec]/10 text-[#135bec]">
                    <span className="material-symbols-outlined text-xl">shopping_bag</span> Đơn hàng của tôi
                  </Link>
                </li>
                <li>
                  <Link to="/wishlist" className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                    <span className="material-symbols-outlined text-xl">favorite</span> Sản phẩm yêu thích
                  </Link>
                </li>
                <li>
                  <Link to="/addresses" className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                    <span className="material-symbols-outlined text-xl">location_on</span> Sổ địa chỉ
                  </Link>
                </li>
                <hr className="my-4 border-slate-200 dark:border-slate-800" />
                <li>
                  <Link to="/login" className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg text-[#D34747] hover:bg-[#D34747]/10 transition-colors">
